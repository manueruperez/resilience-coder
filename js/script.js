(function ($) {
  ...
  $(".wrapper.home").easytabs({
    ...
    tabs: "#main-nav.tabbed > ul > li:not(.link)", // Excluye los elementos con clase .link
  ...
  if (
    ...
    $("#main-nav.tabbed > ul > li:not(.link), .project-nav li a").on(
      "click",
      function () {
  ...
  $(".header-search-form .search-form-icon").on("click", function () {
    ...
    if (
      $(this).closest(".header-search-form").find('input[type="text"]').val()
    ) {
      $(this)
